...
Пользователь 2026-09-04 остановил подбор параметров: после linear compositing стало чуть ближе, но сатин ещё не принят. Сейчас выполняется только изучение iOS-reference и сохранение контекста, без изменения кода. Результаты — [IOS_REFERENCE_CONTEXT.md](IOS_REFERENCE_CONTEXT.md).

После новой команды на реализацию:
